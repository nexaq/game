...
const activeBreakPoints = (config: ActiveBreakPointsConfig) => {
    const breakpoints: BreakPointsMatch = {
        sm: window.matchMedia(`(min-width: ${styleConfig['breakpoint-sm']})`).matches,
        md: window.matchMedia(`(min-width: ${styleConfig['breakpoint-md']})`).matches,
        lg: window.matchMedia(`(min-width: ${styleConfig['breakpoint-lg']})`).matches,
        xl: window.matchMedia(`(min-width: ${styleConfig['breakpoint-xl']})`).matches,
    };
