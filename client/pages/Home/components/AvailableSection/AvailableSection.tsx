...
const AvailableSection: Props = () => {
  return (
    <div>
      <Container>
        <Heading level="h2" addLine uppercase>
          Available starships
        </Heading>
          ...
          {[
            {
              ...
              description:
                "To the enemy, it is a weapon never to be underestimated. To allies, it's a savior. The F7C Hornet is the same dependable and resilient multi-purpose fighter.",
            ...
            },
            {
              ...
              description:
                "the MAR-10 is a fighting spacecraft that packs a deadly punch into a slight fuselage. The spacecraft compensates for its lack of creature comforts with its powerful armament.",
            ...
            },
            {
              ...
              title: "Heavy fighter",
              description:
                "Boasting a heavy cannon and a Lightning Power engine.",
